...
const SystemTKNCTPCK = () => {
    ...
    const fetchProductList = async (date) =>{
        try {
            const res = await axios.get(`http://dichothuecsharp.somee.com/api/static/product/agoPeriod/${date}`) 
                                    .then(res => {
        ...
        <div className="container">
            <div className="grid">
                <div className="row">
                    <div className="dichothue-system__design-description">
                        <h5 className="dichothue-system__design-heading">3. THỐNG KÊ NHU CẦU THỰC PHẨM CÙNG KỲ</h5>
                    </div>
            ...
            <ResponsiveContainer width="100%" height="100%">
                ...
                >
                    ...
                    <Tooltip />
                    <Legend />
                    <Bar dataKey="amount_sale_ago" fill="#8884d8" />
                    <Bar dataKey="amount_sale_now" fill="#82ca9d" />
                </BarChart>
            </ResponsiveContainer>
