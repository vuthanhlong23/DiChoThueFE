...
const StoreLogin = () => {
    ...
    const [cookies, setCookie, removeCookie] = useCookies(["Store_Username", "Store_Password"]);

    const handleSetCookie = () => {
        setCookie('Store_Username', username, { path: '/store' });
        setCookie('Store_Password', encodeCredential(password), { path: '/store' });
    };
    ...
    const handleSubmit = (event) => {
        axios({
            method: 'post',
            url: 'https://market-0123.herokuapp.com/store/login',
            data:
            {  
                username: username,
                password: password
                ...
                <div className="login-auth-form">
                    <div className="auth-form__container">
                        ...
                        <div className="auth-form__header">
                            ...
                            <Link to="/store/register" className="auth-form__switch-btn">Đăng ký</Link>
                        </div>
                        ...
                        <div className="auth-form__aside">
                            <p className="auth-form__register-text">
                                ...
                                <Link to="/store/register" className="auth-form__register-link">Đăng ký ngay</Link>
                            </p>
                        </div>
